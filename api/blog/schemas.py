...
class FeedItem(Schema):
    ...
    authors: Optional[List[Author]] = Field(None, description="The authors of the item.")
...
class JSONFeed(Schema):
    ...
    authors: Optional[List[Author]] = Field(None, description="The authors of the feed.")
    language: Optional[str] = Field(
